...
# from app.ai_functions import admin_data_query_function, create_communication_function, filter_rooms_function, generate_document_function, generate_insights_function, manage_checklist_function, process_maintenance_request_function, schedule_event_function, schedule_showing_function
